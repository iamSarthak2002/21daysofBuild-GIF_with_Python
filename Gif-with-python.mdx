...
In the terminal, navigate to the folder with the Python file using `cd`. For example, if your file and images are in the **Desktop** folder, you can do:
...
- [Project Solution on GitHub](https://github.com/iamSarthak2002/21daysofBuild-GIF_with_Python)
